    ...
    class Config:
        ...
        schema_extra = {
            "example":{
                ...
                "description": "A University based in Cape Town, South Africa",
...
class ResearchGroup(BaseModel):
    ...
    members: List[str] #the id of the users who are on the system and part of this group
    ...
    class Config:
        ...
        schema_extra = {
            "example":{
                ...
                "members":["6325bb90af32380d1e334a73", "6325bb96af32380d1e334a74"]
            }
        }
