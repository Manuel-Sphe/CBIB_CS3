...
export default function ViewResearchGroups() {
    ...
    const researchGroups = [
        ...
        {researchGroup: 'AI for Development & Innovation', university: 'University of Pretoria', image:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/University_of_Pretoria_Coat_of_Arms.png/360px-University_of_Pretoria_Coat_of_Arms.png'},
        ...
        {researchGroup: 'Ethics of AI', university: 'University of Pretoria', image:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/University_of_Pretoria_Coat_of_Arms.png/360px-University_of_Pretoria_Coat_of_Arms.png'},
        {researchGroup: 'Statistics@CAIR-UP', university: 'University of Pretoria', image:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/University_of_Pretoria_Coat_of_Arms.png/360px-University_of_Pretoria_Coat_of_Arms.png'},
    ...
    function ResearchGroupCard({researchGroups}) {
        return (
            <div className='w-full h-1/5 border text-gray-700 rounded mx-4 my-5'>
                <div className='w-full border bg-gray-100 text-gray-700 rounded '>
                    <div className='w-11/12 border text-gray-700 rounded mx-4 my-5'>
                        <img className='mx-20 mt-5' src={researchGroups.image} height={150} width={150}/>
                        <h1 onClick={()=>router.push("/researchGroupAccessControl")} className='flex justify-center text-center font-bold mt-5 hover:text-sky-400 cursor-pointer'>{researchGroups.researchGroup}</h1>
    ...
    return (
        <div className='h-screen w-screen'>
            ...
            <div className='flex justify-around mt-10' >
                <div className='w-1/4'>
                    <h1 className='text-2xl text-sky-400 text-center'>Research Groups</h1>
                    <div className='w-full border bg-gray-100 text-gray-700 rounded '>
                            {researchGroups.map( (title) => <ResearchGroupCard publicationName={title}/>)}
                    </div>
                </div>
            </div>
        </div>
